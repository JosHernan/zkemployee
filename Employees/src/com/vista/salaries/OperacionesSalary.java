...
public class OperacionesSalary {
	@Wire("#salaryCRUD")
	private Window win;
	private salaries selectedRecord;
	...
	public salaries getSelectedRecord() {
	...
	public void setSelectedRecord(salaries selectedRecord) {
	...
	public void initSetup(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("selectedRecord") salaries obtenersalaries,
		...
		if (recordMode.equals("NEW")) {
			this.selectedRecord = new salaries();

		}
		if (recordMode.equals("EDIT")) {
			this.selectedRecord = obtenersalaries;
	...
	public void save() {
		...
		try {
			...
			try {
			 ...
			 if(selectedRecord.getSalary().equals("")){
				 Messagebox.show("Campo Obligatorio:["+"Salary"+"]", "INFORMACIÓN", Messagebox.OK,
							Messagebox.INFORMATION);
	...
	try{
		...
		try {
		 ...
		 if(selectedRecord.getTo_date().equals("")){
		   ...
		   sSQL = "UPDATE salaries SET " +
		   		"salary = '" +selectedRecord.getSalary().trim()+ "', " +
