...
public class OperacionesDeptManager {
	@Wire("#deptManagerCRUD")
	private Window win;
	private dept_manager selectedRecord;
	...
	public dept_manager getSelectedRecord() {
	...
	public void setSelectedRecord(dept_manager selectedRecord) {
	...
	public void initSetup(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("selectedRecord") dept_manager obtenerdept_manager,
		...
		if (recordMode.equals("NEW")) {
			this.selectedRecord = new dept_manager();

		}
		if (recordMode.equals("EDIT")) {
			this.selectedRecord = obtenerdept_manager;
